import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { C as getNitroOrigin, D as prefixStorage, E as useStorage, F as emojiCache, G as useOgImageRuntimeConfig, c as createError, H as fetchIsland, I as createHeadCore, J as normaliseFontInput, K as theme, L as withTrailingSlash, g as getQuery, M as handleCacheHeaders, N as setHeaders, s as setHeader, O as hash, P as parseURL, Q as setResponseHeader, R as proxyRequest, S as sendRedirect, T as resolveContext, U as H3Error } from '../nitro/nitro.mjs';
...
export { applyEmojis as a, fontEventHandler as f, imageEventHandler as i, loadFont as l, useNitroOrigin as u };
