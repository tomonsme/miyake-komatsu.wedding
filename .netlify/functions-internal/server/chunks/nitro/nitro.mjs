...
const _assets = {
  ["nuxt-og-image:fonts:Inter-normal-400.ttf.base64"]: {
    ...
    meta: {"type":"text/plain; charset=utf-8","etag":"\"652cc-qEeSD1DXCSV8gPP2rnBA6ePGdZ4\"","mtime":"2025-11-14T12:29:23.601Z"}
  },
  ["nuxt-og-image:fonts:Inter-normal-700.ttf.base64"]: {
    import: () => import('../raw/Inter-normal-700.ttf.mjs').then(r => r.default || r),
    meta: {"type":"text/plain; charset=utf-8","etag":"\"674f0-FZReUXHhPTnY0HmYVn2iPpKm9ds\"","mtime":"2025-11-14T12:29:23.601Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9a15f33f-a29d-4758-b11e-641d76d17567",
  ...
  "sesFrom": "notify@example.com",
  "sesTo": "host1@example.com,host2@example.com",
  "sesReplyTo": "",
  "sitemap": {
    "isI18nMapped": false,
...
const _3JDdoiqEdSQlnQU_N6SD5LzuaG4Y4LVH_Dnn4IA1Q = defineNitroPlugin(async (nitroApp) => {
...
const _sNvgoQ4vbsoB0uz3d0Gr6NnvM6nAoKe_gqfrP2Nzoi8 = defineNitroPlugin(async (nitroApp) => {
...
const theme = {"colors":{"primary":"rgb(var(--gold) / <alpha-value>)","gold":"rgb(var(--gold) / <alpha-value>)","ink":"rgb(var(--ink) / <alpha-value>)","royal":"rgb(var(--royal) / <alpha-value>)","ivory":"rgb(var(--ivory) / <alpha-value>)","champagne":"rgb(var(--champagne) / <alpha-value>)","soft":"rgb(var(--ivory) / <alpha-value>)"},"fontFamily":{"sans":["\"Noto Sans JP\"","system-ui","Arial","sans-serif"],"display":["\"Playfair Display\"","\"Cormorant Garamond\"","\"Noto Serif JP\"","serif"],"serif":["\"Noto Serif JP\"","serif"]},"boxShadow":{"card":"0 20px 45px -25px rgba(17, 24, 39, 0.35)","glow":"0 10px 25px -10px rgba(189, 160, 106, 0.45)"},"transitionTimingFunction":{"soft":"cubic-bezier(0.4, 0, 0.2, 1)"},"backgroundImage":{"hero-overlay":"linear-gradient(180deg, rgba(0,0,0,.4) 0%, rgba(0,0,0,.6) 100%)"}};
...
const _vGFIx158C2RGmEB0POfKCUzOBms2ZEt3n24G64BDXE = defineNitroPlugin(async (nitro) => {
  return;
});

const plugins = [
  _3JDdoiqEdSQlnQU_N6SD5LzuaG4Y4LVH_Dnn4IA1Q,
_sNvgoQ4vbsoB0uz3d0Gr6NnvM6nAoKe_gqfrP2Nzoi8,
_vGFIx158C2RGmEB0POfKCUzOBms2ZEt3n24G64BDXE
];

const _AW0me2 = eventHandler(async (e) => {
...
const _BMIVtk = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _RlPrSD = defineEventHandler(async (e) => {
...
const _SuNFrj = defineEventHandler(async (e) => {
...
const _4KR1te = defineEventHandler(async (e) => {
...
const appHead = {"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"preload","as":"style","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Cormorant+Garamond:wght@400;600;700&family=Noto+Serif+JP:wght@400;600;700&display=swap","onload":"this.onload=null;this.rel='stylesheet'"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;600;700&family=Cormorant+Garamond:wght@400;600;700&family=Noto+Serif+JP:wght@400;600;700&display=swap"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1, viewport-fit=cover"},{"name":"description","content":"A heartfelt wedding invitation experience for {{COUPLE}}."},{"property":"og:title","content":"Wedding Invitation for {{COUPLE}}"},{"property":"og:description","content":"Join us to celebrate love at {{VENUE_NAME}} on {{DATE_ISO}}."},{"property":"og:type","content":"website"},{"property":"og:image","content":"/og.png"},{"property":"og:image:width","content":"1200"},{"property":"og:image:height","content":"630"},{"name":"twitter:card","content":"summary_large_image"},{"name":"theme-color","content":"#BDA06A"}],"style":[],"script":[],"noscript":[],"title":"Wedding Invitation","htmlAttrs":{}};
...
const _lazy_gCBDhs = () => import('../routes/api/admin/rsvps.get.mjs');
const _lazy_f4wL6I = () => import('../routes/api/rsvp.post.mjs');
const _lazy_rDGdMr = () => import('../routes/api/upload.post.mjs');
const _lazy_UHFOM4 = () => import('../routes/renderer.mjs');
const _lazy_Dc8R1y = () => import('../routes/__og-image__/font/font.mjs');
const _lazy_FHkvME = () => import('../routes/__og-image__/image/image.mjs');

const handlers = [
  { route: '/api/admin/rsvps', handler: _lazy_gCBDhs, lazy: true, middleware: false, method: "get" },
  { route: '/api/rsvp', handler: _lazy_f4wL6I, lazy: true, middleware: false, method: "post" },
  { route: '/api/upload', handler: _lazy_rDGdMr, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _AW0me2, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _BMIVtk, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _RlPrSD, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _SuNFrj, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _4KR1te, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_Dc8R1y, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_FHkvME, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_FHkvME, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/**', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/admin', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/meta/**', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/**', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/**', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UHFOM4, lazy: true, middleware: false, method: undefined }
];
...
export { withQuery as $, replaceIslandTeleports as A, useNitroApp as B, getNitroOrigin as C, prefixStorage as D, useStorage as E, emojiCache as F, useOgImageRuntimeConfig as G, fetchIsland as H, createHeadCore as I, normaliseFontInput as J, theme as K, withTrailingSlash as L, handleCacheHeaders as M, setHeaders as N, hash$1 as O, parseURL as P, setResponseHeader as Q, proxyRequest as R, sendRedirect as S, resolveContext as T, H3Error as U, parseQuery as V, klona as W, defuFn as X, defu as Y, headSymbol as Z, useHead as _, getHeader as a, withoutTrailingSlash as a0, isScriptProtocol as a1, getContext as a2, sanitizeStatusCode as a3, $fetch$1 as a4, baseURL as a5, createHooks as a6, executeAsync as a7, titleCase as a8, toRouteMatcher as a9, createRouter$1 as aa, camelCase as ab, withoutBase as ac, useSeoMeta as ad, stringifyQuery as ae, withLeadingSlash as af, withBase as ag, resolveUnrefHeadInput as ah, decodeHtml as ai, logger$1 as aj, toBase64Image as ak, htmlDecodeQuotes as al, sendError as am, fontCache as an, encodeQueryItem as ao, handler as ap, readMultipartFormData as b, createError$1 as c, defineEventHandler as d, getResponseStatusText as e, getResponseStatus as f, getQuery as g, appId as h, defineRenderHandler as i, buildAssetsURL as j, appTeleportTag as k, appTeleportAttrs as l, createSSRContext as m, appHead as n, destr as o, publicAssetsURL as p, setSSRError as q, readBody as r, setHeader as s, getRouteRules as t, useRuntimeConfig as u, getRenderer as v, getEntryIds as w, renderInlineStyles as x, hasProtocol as y, joinURL as z };
